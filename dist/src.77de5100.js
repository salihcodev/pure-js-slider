...
var rightController = document.querySelector('.right-controller'); // interface SliderProps {
//   slideName: string;
// }

var dataToInject = dataToUse.map(function (slide, idx) {
  var slideName = slide.slideName;
  var whereIam = 'next';
...
slides.innerHTML = dataToInject.join(''); // make the functionality:

var launchTheSlider = function launchTheSlider(action) {
